  ...
  <body>
    ...
    <header>
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="text-center">Insert Information's</h1>
          </div>
        </div>
      </div>
    </header>
                ...
                <form action="" method="">
                 ...
                 <h4>Inline Checkbox</h4>
                  ...
                  <label class="radio-inline">
                    <input type="radio" name="gender" id="gender" value="option1"> Male
                  </label>
                  <label class="radio-inline">
                  ...
                  <div class="form-group">
                    <label for="message">Message</label>
                     <textarea class="form-control" name="message" id="message" rows="5" placeholder="Type your message here..."></textarea>
                  </div>
                  <!-- file -->
                  <div class="form-group">
